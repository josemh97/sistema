...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    <li><a class="app-menu__item active" href="?c=Administrador"><i class="app-menu__icon fa fa-search"></i><span class="app-menu__label">Buscar Beneficiado</span></a></li>
    <li><a class="app-menu__item" href="?c=Administrador&a=FormAgregar"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Registrar Beneficiado</span></a></li>
  </ul>
</aside>
        ...
        <tbody>
          <?php foreach($beneficiados as $beneficiado): ?>
            <tr>
              ...
              <td><a href="index.php?c=Administrador&a=FormAgregar&id=<?= $beneficiado->idBeneficiado; ?>" class="btn btn-block btn-info">
